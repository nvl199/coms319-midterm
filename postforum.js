...
document.querySelector('.post-button').addEventListener('click', function() {
    ...
    newPost.classList.add('post-area'); // This class ensures the styles apply

    // Check if dark mode is enabled and apply the corresponding styles
    ...
    // Append the new post to the main content
